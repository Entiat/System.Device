...
#pragma warning restore IDE0052 // Remove unread private members
    ...
    private void DisposeCheck() => ObjectDisposedException.ThrowIf(m_disposed, this);
...
/// </summary>
public class GeoPositionChangedEventArgs<T>(GeoPosition<T> position) : EventArgs
{
    public GeoPosition<T> Position { get; private set; } = position;
}

/// <summary>
/// Provide Status corresponding to the most recent location change status
/// </summary>
public class GeoPositionStatusChangedEventArgs(GeoPositionStatus status) : EventArgs
{
    public GeoPositionStatus Status { get; private set; } = status;
}

/// <summary>
/// Provide Permission corresponding to the most recent location permission change status
/// </summary>
internal class GeoPermissionChangedEventArgs(GeoPositionPermission permission) : EventArgs
{
    public GeoPositionPermission Permission { get; private set; } = permission;
}
